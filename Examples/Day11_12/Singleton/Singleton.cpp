/* Source of this code: http://cppnuts.com/singleton-design-pattern-in-cpp/ */
#include <iostream>
#include <string>
...
class GameSetting{
	...
	int _width;
	int _height;
	GameSetting() : _width(786), _height(1300), _brightness(75){} // Taks the variables width, height, and brightnesss and sets them to the values specified
