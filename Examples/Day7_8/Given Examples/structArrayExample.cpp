/*
Joseph Duffin 12th July 2018
Udated to include array of struct created on the stack and on the
heap and shows how to access the array elements in two different ways.
...
int main() {
  ...
  /* ********** Arrays of structs examples **********/
 
  // declaring an array of structs. 
  client mlist[2]; 
  
  // initialising the first element of the array by 
  // putting in values into the different fields of the 
  // structure
  mlist[0].name = "Joe";
  mlist[0].age = 29;
  mlist[0].next = NULL;
  
  cout << "Name is " << mlist[0].name << endl;
  
  // Declaring an array of structs from the heap
  client * mlab = new client[4];
   
  mlab[0].name = "Peter";
  mlab[0].age = 89;
  mlab[0].next = NULL; 
   
  cout << "Name is " << mlab[0].name << endl;

  mlab++; // go to the next array element (on the heap)
  
  mlab->name = "Zara";
  mlab->age = 100;
  mlab->next = NULL; 
  
  cout << "Name is " << mlab->name << endl;
